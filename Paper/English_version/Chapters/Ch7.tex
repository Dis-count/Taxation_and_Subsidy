...
***********
gives the method to determine the price

doesnot exist the situation not change the original schedule to stabilize

and there only exist at most three price to choose
commonly is two  depends on the processing time.
