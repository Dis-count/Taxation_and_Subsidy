...
For the coalition $s$, when the price equals $P_i$,where the costs produced by the grand coalition are equal in value, the following formulas hold
$c(V,m)=c_0(s,m)+Pm, c(V,m+1)=c_0(s,m+1)+P(m+1)$. Then we can obtain $P > c(s,m+1)- c(s,m)$
